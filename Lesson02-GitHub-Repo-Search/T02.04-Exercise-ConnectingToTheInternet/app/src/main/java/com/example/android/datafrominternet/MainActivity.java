...
public class MainActivity extends AppCompatActivity {
    ...
    private void makeGithubSearchQuery() {
        ...
        // TODO (2) Call getResponseFromHttpUrl and display the results in mSearchResultsTextView - Done
        // TODO (3) Surround the call to getResponseFromHttpUrl with a try / catch block to catch an IOException - Done
