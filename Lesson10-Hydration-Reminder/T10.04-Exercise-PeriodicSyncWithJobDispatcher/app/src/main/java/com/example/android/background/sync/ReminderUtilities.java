...
public class ReminderUtilities {
    // TODO (15) Create three constants and one variable: - Done
    ...
    // TODO (16) Create a synchronized, public static method called scheduleChargingReminder that takes - Done
    ...
    synchronized public static void scheduleChargingReminder (@NonNull final Context context) {
        ...
        // TODO (21) Use dispatcher's schedule method to schedule the job - Done
        dispatcher.schedule(constraintReminderJob);
        // TODO (22) Set sInitialized to true to mark that we're done setting up the job - Done
        sInitialized = true;
    };
}
