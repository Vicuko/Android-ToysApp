...
public class VisualizerActivity extends AppCompatActivity {
    ...
    private void setupSharedPreferences() {
        ...
        // TODO (4) Use resources here instead of the hard coded string and boolean - Done
        mVisualizerView.setShowBass(sharedPreferences.getBoolean(getString(R.string.show_bass_preference_key), true));
