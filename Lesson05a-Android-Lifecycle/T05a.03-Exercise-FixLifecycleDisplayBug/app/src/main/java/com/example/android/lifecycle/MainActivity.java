...
public class MainActivity extends AppCompatActivity {
    ...
    // TODO (1) Declare and instantiate a static ArrayList of Strings called mLifecycleCallbacks - Done
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TODO (4) Iterate backwards through mLifecycleCallbacks, appending each String and a newline to mLifecycleDisplay - Done
        for (int i = mLifecycleCallbacks.size(); i>0; i--){
            String currentTextView = mLifecycleDisplay.getText().toString();
            String newTextViewContent = currentTextView + mLifecycleCallbacks.get(i-1) + "\n";
            mLifecycleDisplay.setText(newTextViewContent);
        }
    ...
    protected void onStop() {
        ...
        // TODO (2) Add the ON_STOP String to the front of mLifecycleCallbacks - Done
    ...
    protected void onDestroy() {
        ...
        // TODO (3) Add the ON_DESTROY String to the front of mLifecycleCallbacks - Done
